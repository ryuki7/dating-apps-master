...
personalitie_1 = Personalitie.create!(name: '優しい')
personalitie_2 = Personalitie.create!(name: '素直')
personalitie_3 = Personalitie.create!(name: '決断力がある')
personalitie_4 = Personalitie.create!(name: '穏やか')
personalitie_5 = Personalitie.create!(name: '親しみやすい')
personalitie_6 = Personalitie.create!(name: '明るい')
personalitie_7 = Personalitie.create!(name: 'インドア')
personalitie_8 = Personalitie.create!(name: 'アウトドア')
personalitie_9 = Personalitie.create!(name: '真面目')
personalitie_10 = Personalitie.create!(name: '知的')
personalitie_11 = Personalitie.create!(name: '誠実')
personalitie_12 = Personalitie.create!(name: '几帳面')
personalitie_13 = Personalitie.create!(name: '楽観的')
personalitie_14 = Personalitie.create!(name: '照れ屋')
personalitie_15 = Personalitie.create!(name: 'いつも笑顔')
personalitie_16 = Personalitie.create!(name: '上品')
personalitie_17 = Personalitie.create!(name: '落ち着いている')
personalitie_18 = Personalitie.create!(name: '謙虚')
personalitie_19 = Personalitie.create!(name: '厳格')
personalitie_20 = Personalitie.create!(name: '思いやりがある')
personalitie_21 = Personalitie.create!(name: '寂しがり')
personalitie_22 = Personalitie.create!(name: '社交的')
personalitie_23 = Personalitie.create!(name: '冷静沈着')
personalitie_24 = Personalitie.create!(name: '好奇心旺盛')
personalitie_25 = Personalitie.create!(name: '家庭的')
personalitie_26 = Personalitie.create!(name: '仕事好き')
personalitie_27 = Personalitie.create!(name: '責任感がある')
personalitie_28 = Personalitie.create!(name: '面倒見が良い')
personalitie_29 = Personalitie.create!(name: '話し上手')
personalitie_30 = Personalitie.create!(name: '聞き上手')
personalitie_31 = Personalitie.create!(name: 'さわやか')
personalitie_32 = Personalitie.create!(name: '行動的')
personalitie_33 = Personalitie.create!(name: '合理的')
personalitie_34 = Personalitie.create!(name: '負けず嫌い')
personalitie_35 = Personalitie.create!(name: '面白い')
personalitie_36 = Personalitie.create!(name: '熱い')
personalitie_37 = Personalitie.create!(name: '気が利く')
personalitie_38 = Personalitie.create!(name: 'マメ')
personalitie_39 = Personalitie.create!(name: '大胆')
personalitie_40 = Personalitie.create!(name: '寛容')
personalitie_41 = Personalitie.create!(name: '気前がいい')
personalitie_42 = Personalitie.create!(name: '天然と言われる')
personalitie_43 = Personalitie.create!(name: '裏表がない')
personalitie_44 = Personalitie.create!(name: 'マイペース')
personalitie_45 = Personalitie.create!(name: '奥手')
personalitie_46 = Personalitie.create!(name: '気分屋')
