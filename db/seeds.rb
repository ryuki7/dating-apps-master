...
## テスト用のユーザー(usersテーブル)
# 管理者(admin)
User.create!(name: 'テスト', line_id: 'test-line-id', role: 1)
...
step_8_make_girlfriend = Step.create!(name: '8.デート当日(デート別)', description: '女性は男性が思ってる以上に、ニオイに敏感です。家を出る前に必ずニオイケアを行いましょう。.具体的には、.• シャワーを浴びる・制汗剤を使用するなどの体臭対策。.• 女子受けの良い香りの香水を使用する。(匂いがキツい香水だと逆効果な為、爽やかな匂いの香水を使用する。).上記の2点を必ず行うようにしましょう。', description_point: '下記のボタンから、「デートプラン毎」の「アクション」へ遷移します。', purpose_id: 1)
...
step_8_play = Step.create!(name: '8.デート当日(デート別)', description: '女性は男性が思ってる以上に、ニオイに敏感です。家を出る前に必ずニオイケアを行いましょう。.具体的には、.• シャワーを浴びる・制汗剤を使用するなどの体臭対策。.• 女子受けの良い香りの香水を使用する。(匂いがキツい香水だと逆効果な為、爽やかな匂いの香水を使用する。).上記の2点を必ず行うようにしましょう。', description_point: '下記のボタンから、「デートプラン毎」の「アクション」へ遷移します。', purpose_id: 2)
...
step_8_super_play = Step.create!(name: '8.デート当日(デート別)', description: '女性は男性が思ってる以上に、ニオイに敏感です。家を出る前に必ずニオイケアを行いましょう。.具体的には、.• シャワーを浴びる・制汗剤を使用するなどの体臭対策。.• 女子受けの良い香りの香水を使用する。(匂いがキツい香水だと逆効果な為、爽やかな匂いの香水を使用する。).上記の2点を必ず行うようにしましょう。', description_point: '下記のボタンから、「デートプラン毎」の「アクション」へ遷移します。', purpose_id: 3)
...
# id = 1
job_0 = Job.create!(name: '未選択')

# id = +1
job_1 = Job.create!(name: '大手企業')
job_2 = Job.create!(name: '公務員')
job_3 = Job.create!(name: '受付')
job_4 = Job.create!(name: '事務員')
job_5 = Job.create!(name: '看護師')
job_6 = Job.create!(name: '保育士')
job_7 = Job.create!(name: '客室乗務員')
job_8 = Job.create!(name: '秘書')
job_9 = Job.create!(name: '教育関連')
job_10 = Job.create!(name: '福祉・介護')
job_11 = Job.create!(name: '調理師・栄養士')
job_12 = Job.create!(name: 'アパレル・ショップ')
job_13 = Job.create!(name: '美容関係')
job_14 = Job.create!(name: 'ブライダル')
job_15 = Job.create!(name: '金融')
job_16 = Job.create!(name: '保険')
job_17 = Job.create!(name: '広告')
job_18 = Job.create!(name: 'マスコミ')
job_19 = Job.create!(name: 'WEB業界')
job_20 = Job.create!(name: '上場企業')
job_21 = Job.create!(name: '経営者・役員')
job_22 = Job.create!(name: '医師')
job_23 = Job.create!(name: '薬剤師')
job_24 = Job.create!(name: '弁護士')
job_25 = Job.create!(name: '公認会計士')
job_26 = Job.create!(name: 'パイロット')
job_27 = Job.create!(name: '大手商社')
job_28 = Job.create!(name: 'コンサル')
job_29 = Job.create!(name: '大手外資')
job_30 = Job.create!(name: '外資金融')
job_31 = Job.create!(name: 'IT関連')
job_32 = Job.create!(name: 'クリエイター')
job_33 = Job.create!(name: 'アナウンサー')
job_34 = Job.create!(name: '芸能・モデル')
job_35 = Job.create!(name: 'イベントコンパニオン')
job_36 = Job.create!(name: 'スポーツ選手')
job_37 = Job.create!(name: '接客業')
job_38 = Job.create!(name: '不動産')
job_39 = Job.create!(name: '建築関連')
job_40 = Job.create!(name: '通信')
job_41 = Job.create!(name: '流通')
job_42 = Job.create!(name: '製薬')
job_43 = Job.create!(name: '食品関連')
job_44 = Job.create!(name: '旅行関係')
job_45 = Job.create!(name: 'エンターテインメント')
job_46 = Job.create!(name: '会社員')
job_47 = Job.create!(name: '学生')
job_48 = Job.create!(name: '自由業')
job_49 = Job.create!(name: '税理士')
job_50 = Job.create!(name: 'エンジニア')
job_51 = Job.create!(name: '建築士')
job_52 = Job.create!(name: '美容師')
job_53 = Job.create!(name: '歯科医師')
job_54 = Job.create!(name: '歯科衛生士')
job_55 = Job.create!(name: 'その他')


## 性格(personalitiesテーブル)

# id = 1
personalitie_0 = Personality.create!(name: '未選択')

# id = +1
personalitie_1 = Personality.create!(name: '優しい')
personalitie_2 = Personality.create!(name: '素直')
personalitie_3 = Personality.create!(name: '決断力がある')
personalitie_4 = Personality.create!(name: '穏やか')
personalitie_5 = Personality.create!(name: '親しみやすい')
personalitie_6 = Personality.create!(name: '明るい')
personalitie_7 = Personality.create!(name: 'インドア')
personalitie_8 = Personality.create!(name: 'アウトドア')
personalitie_9 = Personality.create!(name: '真面目')
personalitie_10 = Personality.create!(name: '知的')
personalitie_11 = Personality.create!(name: '誠実')
personalitie_12 = Personality.create!(name: '几帳面')
personalitie_13 = Personality.create!(name: '楽観的')
personalitie_14 = Personality.create!(name: '照れ屋')
personalitie_15 = Personality.create!(name: 'いつも笑顔')
personalitie_16 = Personality.create!(name: '上品')
personalitie_17 = Personality.create!(name: '落ち着いている')
personalitie_18 = Personality.create!(name: '謙虚')
personalitie_19 = Personality.create!(name: '厳格')
personalitie_20 = Personality.create!(name: '思いやりがある')
personalitie_21 = Personality.create!(name: '寂しがり')
personalitie_22 = Personality.create!(name: '社交的')
personalitie_23 = Personality.create!(name: '冷静沈着')
personalitie_24 = Personality.create!(name: '好奇心旺盛')
personalitie_25 = Personality.create!(name: '家庭的')
personalitie_26 = Personality.create!(name: '仕事好き')
personalitie_27 = Personality.create!(name: '責任感がある')
personalitie_28 = Personality.create!(name: '面倒見が良い')
personalitie_29 = Personality.create!(name: '話し上手')
personalitie_30 = Personality.create!(name: '聞き上手')
personalitie_31 = Personality.create!(name: 'さわやか')
personalitie_32 = Personality.create!(name: '行動的')
personalitie_33 = Personality.create!(name: '合理的')
personalitie_34 = Personality.create!(name: '負けず嫌い')
personalitie_35 = Personality.create!(name: '面白い')
personalitie_36 = Personality.create!(name: '熱い')
personalitie_37 = Personality.create!(name: '気が利く')
personalitie_38 = Personality.create!(name: 'マメ')
personalitie_39 = Personality.create!(name: '大胆')
personalitie_40 = Personality.create!(name: '寛容')
personalitie_41 = Personality.create!(name: '気前がいい')
personalitie_42 = Personality.create!(name: '天然と言われる')
personalitie_43 = Personality.create!(name: '裏表がない')
...
## デートタスク(tasksテーブル)
task_1 = Task.create!(name: 'デート終了後、相手からメッセージが来る or 自分の送ったメッセージに返信が来る', point: 1)
task_2 = Task.create!(name: '次のデートのお誘いにOKを貰える or 次のデートに誘われる', point: 4)
task_3 = Task.create!(name: '体同士が当たる距離 or 至近距離にいても避けられない(能動的)', point: 6)
task_4 = Task.create!(name: '体同士が当たる距離 or 至近距離にいても避けられない(受動的)', point: 8)
task_5 = Task.create!(name: '間接キスをする', point: 3)
task_6 = Task.create!(name: '頭・髪の毛を触る', point: 2)
task_7 = Task.create!(name: '手を繋ぐ', point: 7)
task_8 = Task.create!(name: 'ハグをする', point: 8)
task_9 = Task.create!(name: 'キスをする', point: 10)
task_10 = Task.create!(name: 'キスより先をする', point: 15)
task_11 = Task.create!(name: '告白をする', point: 20)
