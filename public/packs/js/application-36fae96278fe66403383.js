...
if (prefectures_select_button) {
  if (prefectures_select_button.textContent == '都道府県を選択してください') {} else {
    prefectures_select_button_create_OK = 1; //後者のセレクトをプラグインに適用
...
(function ($) {
  $.fn.selModal = function () {
    ...
    SEL_PARENT.each(function (i) {
      ...
      if (select_this[0].id == "city_select_element" && prefectures_select_button_create_OK == 0) {} else {
  ...
  $.fn.selModalSetValue = function (value) {
    ...
    if (sel_dom[0].id == "city_select_element" && prefectures_select_button_create_OK == 0) {} else {
      sel_dom.val(value);
...
/******/ });
//# sourceMappingURL=application-36fae96278fe66403383.js.map