...
(function ($) {
  $.fn.selModal = function () {
    ...
    SEL_PARENT.each(function (i) {
      ...
      if (selected_name === undefined) {
        ...
        } else if ($(this).id == "address_select_element") {
          button_html = '<button type="button" class="selModalButton" data-selmodalbtn="' + sel_name_attr + '" id="address_select_button">' + selected_name + '</button>';
        } else {
  ...
  prefectures_select_button.classList.add('sw');
...
if (prefectures_select_button) {
  if (!prefectures_select_button.textContent == '都道府県を選択してください') {
    var _address_select_element2 = document.getElementById("address_select_element");

    var _address_select_button2 = _address_select_element2.nextElementSibling;

    _address_select_button2.classList.remove('sw');
  }
}
...
/******/ });
//# sourceMappingURL=application-16f77036ff57cdceb41e.js.map