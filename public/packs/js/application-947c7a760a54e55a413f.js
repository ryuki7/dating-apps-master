...
var city_select_element_option_value_0 = city_select_element_fake.firstElementChild; // リセットボタン(「市を入力するボタン」をクリック後、再度「都道府県ボタン」をクリックすると、初期状態に戻す。)
  ...
  city_select_start_button.addEventListener('mouseup', function () {
    if (prefectures_select_button.textContent == '都道府県を選択してください') {
      ...
      if (!city_select_button_fake_delete) {
        ...
        city_select_element.appendChild(city_select_element_option_value_0); // 市のセレクトボタン(button)のフェイク
...
/******/ });
//# sourceMappingURL=application-947c7a760a54e55a413f.js.map