...
if (make_girlfriend_hidden_field) {
  toggle_switch.addEventListener('click', function () {
    ...
    toggle_radius_button.style.zIndex = '3';
  });
}

if (toggle_radius_button) {
  toggle_radius_button.addEventListener('click', function () {
    toggle_radius_button.click();
    toggle_radius_button.style.zIndex = '-1'; // classをadd
...
/******/ });
//# sourceMappingURL=application-793633913503d4565485.js.map