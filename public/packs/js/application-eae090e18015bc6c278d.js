...
// 彼女作り
var make_girlfriend_character = document.getElementById("make_girlfriend_character");
var make_girlfriend_character_css = getComputedStyle(make_girlfriend_character); // 遊び

var play_character = document.getElementById("play_character"); // ステップボタン
...
var toggle_switch_css = getComputedStyle(toggle_switch); // make_girlfriend_hidden フィールド

var make_girlfriend_hidden_field = document.getElementById("make_girlfriend_hidden_field"); // play_hidden フィールド作成 

var play_hidden_field_create = document.createElement('input');
play_hidden_field_create.type = 'hidden';
play_hidden_field_create.id = 'play_hidden_field';
var toggle_radius_button = document.getElementById("toggle-radius-button");
var toggle_radius_button_create = document.createElement('button');
toggle_radius_button_create.type = 'button';
toggle_radius_button_create.id = 'toggle-radius-button'; // トグルスイッチをクリックする(切り替える)と、ステップボタンの色を変更
// 「彼女作り」 => 「遊び」 にトグルスイッチを切り替える。(青 => ピンク)

if (make_girlfriend_hidden_field) {
  toggle_switch.addEventListener('click', function () {
    ...
    step_button_8.classList.add('play-button'); // classをremove
    ...
    if (toggle_radius_button.classList.contains("hidden")) {
      toggle_radius_button.classList.remove('hidden');
    } else if (!toggle_radius_button) {
      toggle_switch.after(toggle_radius_button_create);

      var _toggle_radius_button = document.getElementById("toggle-radius-button");
    }
  });
}
...
if (toggle_radius_button) {
  toggle_radius_button.addEventListener('click', function () {
    toggle_radius_button.remove();
    toggle_switch.click(); // classをadd
    ...
    step_button_8.classList.add('make_girlfriend-button'); // classをremove
...
var play_hidden_field = document.getElementById("play_hidden_field"); // make_girlfriend_hidden フィールド作成 

var make_girlfriend_hidden_field_create = document.createElement('input');
make_girlfriend_hidden_field_create.type = 'hidden';
make_girlfriend_hidden_field_create.id = 'make_girlfriend_hidden_field'; // 「遊び」 => 「彼女作り」 にトグルスイッチを切り替える。(ピンク => 青)
...
/******/ });
//# sourceMappingURL=application-eae090e18015bc6c278d.js.map