    ...
    SEL_PARENT.each(function (i) {
      ...
      if (select_this[0].id == "city_select_element" && city_select_button_create_OK == 0) {} else {
        ...
        for (var i = 0; i < aryChild.length; i++) {
          ...
          if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].id == "app_select_element") {
            var targets_edit_app = document.getElementById("targets_edit_app");
            selected = targets_edit_app.textContent;
          } // appearance


          if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].id == "appearance_select_element") {
          ...
          if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "age") {
            var _targets_edit_appearance = document.getElementById("targets_edit_appearance");

            selected = _targets_edit_appearance.textContent;
          }
...
/******/ });
//# sourceMappingURL=application-d7d87f4ec065484493c3.js.map