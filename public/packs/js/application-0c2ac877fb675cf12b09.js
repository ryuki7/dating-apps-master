...
function beforesubmit_date_registration_select_check() {
  ...
  var date_registration_date_plan_error_message = document.getElementById("date_registration_date_plan_error_message"); // バリデーション失敗(アプリ)
...
var options = {
  ...
  onDraw: function button_text_color_change_Saturday_and_Sunday() {
    ...
    for (var _i2 = 0; _i2 < weekdaysAbbrev_array.length; _i2++) {
      // 日曜日 abbrev(アブリーヴ)カラー変更 (赤色)
      if (weekdaysAbbrev_array[_i2].title == "日曜日") {
        weekdaysAbbrev_array[_i2].style = "color: rgb(255, 225, 225);";
      } // 土曜日 abbrev(アブリーヴ)カラー変更 (青色)


      if (weekdaysAbbrev_array[_i2].title == "土曜日") {
        weekdaysAbbrev_array[_i2].style = "color: rgb(225, 233, 255);";
      }
    }
  }
};
...
/******/ });
//# sourceMappingURL=application-0c2ac877fb675cf12b09.js.map