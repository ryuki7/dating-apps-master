  ...
  city_select_start_button.addEventListener('mouseup', function () {
    if (prefectures_select_button.textContent == '都道府県を選択してください') {} else {
      ...
      if (!city_select_button_fake_delete) {
        ...
        var city_select_option_elements_array = document.querySelectorAll("#".concat(prefectures_select_button.textContent, "_option"));
...
/******/ });
//# sourceMappingURL=application-5688712c7be7ef9ef22f.js.map