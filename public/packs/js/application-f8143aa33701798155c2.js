  ...
  city_select_start_button.addEventListener('mouseup', function () {
    if (prefectures_select_button.textContent == '都道府県を選択してください') {} else {
      ...
      if (!city_select_button_fake_delete) {
        ...
        var city_select_option_elements_array = document.getElementById(prefectures_select_button.textContent);
...
/******/ });
//# sourceMappingURL=application-f8143aa33701798155c2.js.map