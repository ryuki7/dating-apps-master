...
$(document).ready(function () {
  ...
  if ($('.new-option').size() == 0) {
    $('.old-select option').each(function () {
      ...
      if (newHTML == '彼女作り') {
        $('.new-select').append('<div class="new-option" data-value="' + newValue + '"><p><a id="app-strategies-app-select-pulldown" href="../step">' + newHTML + '</p></a></div>');
      }
...
/******/ });
//# sourceMappingURL=application-7d2febb62f6e082bc588.js.map