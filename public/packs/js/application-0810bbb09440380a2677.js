...
// 彼女作り
var make_girlfriend_character = document.getElementById("make_girlfriend_character"); // 遊び
...
var step_button_8 = document.getElementById("app-strategies-step-button-8"); // トグルスイッチ(本当は裏に隠してあるボタン)

var switch_button = document.getElementById("purpose_button"); // make_girlfriend_hidden フィールド
...
play_hidden_field_create.id = 'play_hidden_field'; // トグルスイッチをクリックする(切り替える)と、ステップボタンの色を変更
...
if (make_girlfriend_hidden_field) {
  switch_button.addEventListener('click', function () {
    ...
    var switch_button_create = document.createElement('button');
    switch_button_create.type = 'button';
    switch_button_create.id = 'purpose_button';
    var toggle_switch = document.createElement('toggle_switch');
    toggle_switch.after(switch_button_create);
  });
} // play_hidden フィールド
...
var switch_button2 = document.getElementById("purpose_button"); // 「遊び」 => 「彼女作り」 にトグルスイッチを切り替える。(ピンク => 青)

if (play_hidden_field) {
  switch_button2.addEventListener('click', function () {
    // classをadd
    ...
    make_girlfriend_character.after(make_girlfriend_hidden_field_create);
    play_hidden_field.remove();
  });
}
...
/******/ });
//# sourceMappingURL=application-0810bbb09440380a2677.js.map