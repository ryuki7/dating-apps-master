...
/***/ "./app/javascript/channels/user.js":
/*!*****************************************!*\
  !*** ./app/javascript/channels/user.js ***!
  \*****************************************/
/*! no exports provided */
...
document.addEventListener('DOMContentLoaded', function () {
  var myLiffId = "1656234930-4MZoRoZd";
  ...
  function idTokenSendToController(csrfToken) {
    var idToken = liff.getIDToken(); // lineのユーザーIDトークンを取得
    ...
    fetch(request).then(function (response) {
      console.log(response); // このブロックの中ではPromiseではなくて、通常の値として扱える
...
/******/ });
//# sourceMappingURL=top-76cbf39755cae3af0373.js.map