...
var play_character_css = getComputedStyle(play_character); // ステップボタン
...
var toggle_switch = document.getElementById("toggle_switch"); // フィールド

var make_girlfriend_hidden_field = document.getElementById("make_girlfriend_hidden_field");
...
if (make_girlfriend_hidden_field) {
  toggle_switch.addEventListener('click', function () {
    ...
    play_hidden_field_create();
    make_girlfriend_hidden_field.remove();
  });
}

function play_hidden_field_create() {
  var play_hidden_field = document.createElement('input');
  play_hidden_field.type = 'hidden';
  play_hidden_field.id = 'play_hidden_field';
}
...
/******/ });
//# sourceMappingURL=application-95f3f4b7d8571a1dc851.js.map