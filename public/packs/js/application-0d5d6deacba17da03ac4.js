...
var options = {
  ...
  onDraw: function button_text_color_change_Saturday_and_Sunday() {
    ...
    for (var i = 0; i < datepicker_row_array.length; i++) {
      ...
      Sunday_button.style = "background-color: rgb(255, 225, 225);"; // 土曜日 ボタンカラー変更 (青色)
    ...
    for (var _i = 0; _i < weekdaysAbbrev_array.length; _i++) {
      // 日曜日 abbrev(アブリーヴ)カラー変更 (赤色)
      if (weekdaysAbbrev_array[_i].title == "日曜日") {
        weekdaysAbbrev_array[_i].style = "color: rgb(255, 225, 225);";
      } // 土曜日 abbrev(アブリーヴ)カラー変更 (青色)


      if (weekdaysAbbrev_array[_i].title == "土曜日") {
        weekdaysAbbrev_array[_i].style = "color: rgb(225, 233, 255);";
      }
    }
  }
};
...
/******/ });
//# sourceMappingURL=application-0d5d6deacba17da03ac4.js.map