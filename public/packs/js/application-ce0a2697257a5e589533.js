  ...
  $.fn.selModal = function () {
    ...
    SEL_PARENT.each(function (i) {
      ...
      for (var i = 0; i < aryChild.length; i++) {
        ...
        if (selected != i) {
          modal_html += '<li class="selModalClose" id="app_icon_image_modal" data-value="' + aryChild.eq(i).attr('value') + '">' + img_div + aryChild.eq(i).text() + '</li>';
        } else {
...
/******/ });
//# sourceMappingURL=application-ce0a2697257a5e589533.js.map