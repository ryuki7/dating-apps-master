...
if (prefectures_select_button) {
  prefectures_select_button.addEventListener('mousedown', function () {
    ...
    var prefectures_select_button_city_input_discrimination = document.getElementById("prefectures_select_button");

    if (targets_registration_city_input_error_message && !prefectures_select_button_city_input_discrimination.textContent == !'都道府県を選択してください') {
...
/******/ });
//# sourceMappingURL=application-b099dbc593bf87d6a9c2.js.map