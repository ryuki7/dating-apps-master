...
var options = {
  ...
  i18n: inter_en,
  showClearBtn: true,
  onDraw: function button_background_color_change_Saturday_and_Sunday() {
    ...
    for (var i = 0; i < datepicker_row_array.length; i++) {
      ...
      Sunday_button.style = "background-color: red;"; // 土曜日 ボタンカラー変更(青色)

      Saturday_td = datepicker_row_array[i].lastElementChild;
      Saturday_button = Saturday_td.firstElementChild;
      Saturday_button.style = "background-color: blue;";
    }
  }
};
...
function button_background_color_change_Saturday_and_Sunday() {
  var datepicker_row_array = document.querySelectorAll(".datepicker-row");
...
/******/ });
//# sourceMappingURL=application-3c74b627c84def901b79.js.map