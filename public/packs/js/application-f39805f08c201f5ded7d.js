...
if (prefectures_select_button) {
  prefectures_select_button.addEventListener('mousedown', function () {
    ...
    if (city_select_button_fake_delete) {
      var selModal = document.getElementsByClassName("selModal");
      selModal[8].remove();
            ...
            SEL_PARENT.each(function (i) {
              ...
              if (select_this[0].id == "city_select_element" && city_select_button_create_OK == 0) {} else {
                ...
                for (var i = 0; i < aryChild.length; i++) {
                  ...
                  if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "prefecture") {
                    ...
                    for (var i = 0; i < prefecture_option_array.length; i++) {
                  ...
                  if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "city") {
                    city_select_start_button.click();
                    ...
                    for (var i = 0; i < city_option_array.length; i++) {
                  ...
                  if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "personality_id") {
    ...
    SEL_PARENT.each(function (i) {
      ...
      if (select_this[0].id == "city_select_element" && city_select_button_create_OK == 0) {} else {
        ...
        for (var i = 0; i < aryChild.length; i++) {
          ...
          if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "app_id") {
            var targets_edit_app = document.getElementById("targets_edit_app");
            selected = targets_edit_app.textContent;
            var targets_edit_next_step = "app_end";
          } // appearance


          if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "appearance_id") {
            var targets_edit_appearance = document.getElementById("targets_edit_appearance");
            selected = targets_edit_appearance.textContent;
          } // age


          if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "age") {
            var targets_edit_age = document.getElementById("targets_edit_age");
            selected = targets_edit_age.textContent;
          } // purpose


          if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "purpose_id") {
            var targets_edit_purpose = document.getElementById("targets_edit_purpose");
            selected = targets_edit_purpose.textContent;
          } // job


          if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "job_id") {
            var targets_edit_job = document.getElementById("targets_edit_job");
            selected = targets_edit_job.textContent;
          } // height


          if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "height") {
            var targets_edit_height = document.getElementById("targets_edit_height");
            selected = targets_edit_height.textContent;
          } // prefecture
          ...
          if (targets_edit_sign_input && targets_edit_discrimination == "start" && select_this[0].name == "city") {
            ...
            for (var i = 0; i < city_option_array.length; i++) {
              if (city_name == city_option_array[i]) {
                selected = i;
              }
            }
          } // personality
...
/******/ });
//# sourceMappingURL=application-f39805f08c201f5ded7d.js.map