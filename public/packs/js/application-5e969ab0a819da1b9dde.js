...
var app_strategies_step_button_wrapper = document.getElementById("app-strategies-step-button-wrapper"); // トグルスイッチ
...
if (toggle_switch) {
  toggle_switch.addEventListener('click', function () {
    ...
    toggle_radius_button.classList.remove('hidden'); // ステップボタンのhref(url)を変更
    // ステップボタン1
...
/******/ });
//# sourceMappingURL=application-5e969ab0a819da1b9dde.js.map