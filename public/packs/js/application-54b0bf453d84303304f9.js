...
var toggle_switch_css = window.getComputedStyle(toggle_switch); // make_girlfriend_hidden フィールド
...
var error_message = document.createElement('p');
error_message.textContent = 'どれか1つは選択して下さい';
error_message.id = 'test';
toggle_switch.addEventListener('click', function () {
  make_girlfriend_character.after(error_message);
});
var error_message_get = document.getElementById("test");
var error_message_css = window.getComputedStyle(error_message_get); // 「遊び」 => 「彼女作り」 にトグルスイッチを切り替える。(ピンク => 青)

if (error_message_css.color == toggle_switch_css.borderColor) {
  toggle_switch.addEventListener('click', function () {
    // classをadd
...
/******/ });
//# sourceMappingURL=application-54b0bf453d84303304f9.js.map