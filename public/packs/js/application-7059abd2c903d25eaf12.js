...
function beforesubmit_select_check() {
  ...
  } else if (!purpose_select_button.textContent == 'アプリを選択してください' && !targets_registration_app_error_message == null) {
  ...
  } else if (!purpose_select_button.textContent == '容姿を選択してください' && !targets_registration_appearance_error_message == null) {
  ...
  } else if (!purpose_select_button.textContent == '名前を選択してください' && !targets_registration_name_error_message == null) {
...
/******/ });
//# sourceMappingURL=application-7059abd2c903d25eaf12.js.map