...
var city_select_button_fake = null; // リセットボタン(「市を入力するボタン」をクリック後、再度「都道府県ボタン」をクリックすると、初期状態に戻す。)
...
if (prefectures_select_button && city_select_start_button) {
  city_select_start_button.addEventListener('mouseup', function () {
    if (prefectures_select_button.textContent == '都道府県を選択してください') {} else {
      ...
      var city_select_element_children = city_select_element.children;
      var city_select_button_fake_delete = document.getElementById("hidden");
...
/******/ });
//# sourceMappingURL=application-4408023c573afbfc6b6e.js.map