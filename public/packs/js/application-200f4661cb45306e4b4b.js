...
if (prefectures_select_button && city_select_button_fake) {
  prefectures_select_button.addEventListener('click', function () {
    ...
    city_select_button["class"] = 'selModalButton hidden';
    city_select_element.after(city_select_button);
    city_select_button_fake.remove();
  });
}
...
if (prefectures_select_button && city_select_start_button) {
  city_select_start_button.addEventListener('click', function () {
    if (prefectures_select_button.textContent == '都道府県を選択してください') {} else {
      ...
      var city_select_button_fake = document.createElement('button');
      city_select_button_fake.textContent = 'フェイク';
      city_select_button_fake.id = 'city_select_button';
      city_select_button_fake.type = 'button';
      city_select_button_fake["class"] = 'selModalButton hidden';
...
/******/ });
//# sourceMappingURL=application-200f4661cb45306e4b4b.js.map