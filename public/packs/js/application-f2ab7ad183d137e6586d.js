...
if (prefectures_select_button) if (!prefectures_select_button.textContent == '都道府県を選択してください') {
  $(function () {
    //後者のセレクトをプラグインに適用
    ...
    SEL_PARENT.each(function (i) {
      ...
      if (selected_name === undefined) {
        ...
        if (i == 48) {
          ...
          button_html = '<button type="button" class="selModalButton hidden" data-selmodalbtn="' + sel_name_attr + '" id="city_select_button">' + selected_name + '</button>';
        } else {
...
/******/ });
//# sourceMappingURL=application-f2ab7ad183d137e6586d.js.map