...
var button = document.getElementById("app-diagnostics-description-select-button");
var hidden_field = document.getElementById("allocation-1-1");
button.addEventListener('click', function () {
  if (hidden_field.classList.contains("hidden")) {
    button.classList.add('buttongreen');
    button.classList.remove('buttonwhite');
    hidden_field.classList.remove('hidden');
  } else {
    button.classList.add('buttonwhite');
    button.classList.remove('buttongreen');
    hidden_field.classList.add('hidden');
  }
});

function checkText() {
  //入力ボックスの内容を表示する
  console.log(document.myform.mytext.value);
}
...
/******/ });
//# sourceMappingURL=application-4cd7d8d12315497f1c51.js.map