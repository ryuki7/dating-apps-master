  ...
  city_select_start_button.addEventListener('mouseup', function () {
    if (prefectures_select_button.textContent == '都道府県を選択してください') {} else {
      ...
      if (!city_select_button_fake_delete) {
        ...
        city_select_element.remove(); // 「市」selectタグを追加
        ...
        city_select_start_button.after(city_select_element_create); // 「市」selectタグのoptionの初めを追加(子要素)

        var city_select_element_child_option_beginning_create = document.createElement('option');
        ...
        city_select_element_create.appendChild(city_select_element_child_option_beginning_create); // 「市」selectタグのoption選択データを追加(子要素) 

        var tokyo = document.getElementById(prefectures_select_button.textContent);
...
/******/ });
//# sourceMappingURL=application-feef457b6c7d3a498b84.js.map