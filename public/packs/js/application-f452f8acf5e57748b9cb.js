...
if (prefectures_select_button) {
  var _prefectures_select_button = document.getElementById("prefectures_select_button");

  if (!_prefectures_select_button.textContent == '都道府県を選択してください') {
    var address_select_element = document.getElementById("address_select_element");
    var address_select_button = address_select_element.nextElementSibling;
    address_select_button.classList.remove('hidden');
  }
}
...
/******/ });
//# sourceMappingURL=application-f452f8acf5e57748b9cb.js.map