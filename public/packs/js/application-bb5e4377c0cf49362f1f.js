  ...
  $.fn.selModal = function () {
    ...
    SEL_PARENT.each(function (i) {
      ...
      if (selected_name === undefined) {
        ...
        } else if (select_this.id == "address_select_element") {
...
if (address_select_element) {
  ...
  address_select_button.classList.add('hidden');
}
...
if (prefectures_select_button) {
  if (!prefectures_select_button.textContent == '都道府県を選択してください') {
    ...
    _address_select_button.classList.remove('hidden');
  }
}
...
/******/ });
//# sourceMappingURL=application-bb5e4377c0cf49362f1f.js.map