...
function beforesubmit_date_registration_select_check() {
  var date_registration_submit_button = document.getElementById("date_registration_submit_button");
  var date_registration_datepicker_error_message = document.getElementById("date_registration_datepicker_error_message");
  var date_registration_date_plan_error_message = document.getElementById("date_registration_date_plan_error_message"); // バリデーション失敗(日付)

  if (!date_registration_selected_check.classList.contains('ok') && date_registration_datepicker_error_message == null) {
    // エラーメッセージ生成
    var datepicker_error_message = document.createElement('p');
  ...
  if (date_plan_select_button.textContent == 'デートプランを選択してください' && date_registration_date_plan_error_message == null) {
    // エラーメッセージ生成
    var date_plan_error_message = document.createElement('p');
...
function beforesubmit_date_plan_detail_redirect_select_check() {
  var date_plan_detail_redirect_submit_button = document.getElementById("date_plan_detail_redirect_submit_button");
  var date_plan_detail_redirect_error_message = document.getElementById("date_plan_detail_redirect_error_message"); // バリデーション失敗(アプリ)

  if (date_plan_detail_redirect_select_button.textContent == 'デートプランを選択してください' && date_plan_detail_redirect_error_message == null) {
    // エラーメッセージ生成
    var _date_plan_detail_redirect_error_message = document.createElement('p');

    _date_plan_detail_redirect_error_message.textContent = '「デートプラン」は選択必須です。';
    _date_plan_detail_redirect_error_message.id = 'date_plan_detail_redirect_error_message';
    date_plan_detail_redirect_submit_button.before(_date_plan_detail_redirect_error_message);
...
/***/ "./app/javascript/channels/date_result.js":
/*!************************************************!*\
  !*** ./app/javascript/channels/date_result.js ***!
  \************************************************/
/*! no static exports found */
...
var history_task_result_1 = document.getElementById("history_task_result_1");
var history_task_result_2 = document.getElementById("history_task_result_2");
var history_task_result_3 = document.getElementById("history_task_result_3");
var history_task_result_4 = document.getElementById("history_task_result_4");
var history_task_result_5 = document.getElementById("history_task_result_5");
var history_task_result_6 = document.getElementById("history_task_result_6");
var history_task_result_7 = document.getElementById("history_task_result_7");
var history_task_result_8 = document.getElementById("history_task_result_8");
var history_task_result_9 = document.getElementById("history_task_result_9");
var history_task_result_10 = document.getElementById("history_task_result_10");
var history_task_result_11 = document.getElementById("history_task_result_11");

if (history_task_result_1) {
  switch (history_task_result_1.textContent) {
    case "成功":
      history_task_result_1.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_1.style = "color: red;";
      break;
  }
}

if (history_task_result_2) {
  switch (history_task_result_2.textContent) {
    case "成功":
      history_task_result_2.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_2.style = "color: red;";
      break;
  }
}

if (history_task_result_3) {
  switch (history_task_result_3.textContent) {
    case "成功":
      history_task_result_3.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_3.style = "color: red;";
      break;
  }
}

if (history_task_result_4) {
  switch (history_task_result_4.textContent) {
    case "成功":
      history_task_result_4.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_4.style = "color: red;";
      break;
  }
}

if (history_task_result_5) {
  switch (history_task_result_5.textContent) {
    case "成功":
      history_task_result_5.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_5.style = "color: red;";
      break;
  }
}

if (history_task_result_6) {
  switch (history_task_result_6.textContent) {
    case "成功":
      history_task_result_6.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_6.style = "color: red;";
      break;
  }
}

if (history_task_result_7) {
  switch (history_task_result_7.textContent) {
    case "成功":
      history_task_result_7.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_7.style = "color: red;";
      break;
  }
}

if (history_task_result_8) {
  switch (history_task_result_8.textContent) {
    case "成功":
      history_task_result_8.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_8.style = "color: red;";
      break;
  }
}

if (history_task_result_9) {
  switch (history_task_result_9.textContent) {
    case "成功":
      history_task_result_9.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_9.style = "color: red;";
      break;
  }
}

if (history_task_result_10) {
  switch (history_task_result_10.textContent) {
    case "成功":
      history_task_result_10.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_10.style = "color: red;";
      break;
  }
}

if (history_task_result_11) {
  switch (history_task_result_11.textContent) {
    case "成功":
      history_task_result_11.style = "color: rgb(0, 241, 0);";
      break;

    case "失敗":
      history_task_result_11.style = "color: red;";
      break;
  }
}
...
var options = {
  ...
  onDraw: function button_text_color_change_Saturday_and_Sunday() {
    ...
    for (var i = 0; i < datepicker_row_array.length; i++) {
      // 日曜日 ボタンカラー変更 (ピンク色)
      ...
      for (var _i = 0; _i < one_row_of_all_td_array.length; _i++) {
        if (one_row_of_all_td_array[_i].classList.contains("is-today")) {
          today_button = one_row_of_all_td_array[_i].firstElementChild;
      ...
      for (var _i2 = 0; _i2 < one_row_of_all_td_array.length; _i2++) {
        if (one_row_of_all_td_array[_i2].classList.contains("is-selected") && !date_registration_selected_check.classList.contains('ok')) {
    ...
    for (var _i3 = 0; _i3 < weekdaysAbbrev_array.length; _i3++) {
      // 日曜日 abbrev(アブリーヴ)カラー変更 (赤色)
      if (weekdaysAbbrev_array[_i3].title == "日曜日") {
        weekdaysAbbrev_array[_i3].style = "color: rgb(255, 225, 225);";
      } // 土曜日 abbrev(アブリーヴ)カラー変更 (青色)


      if (weekdaysAbbrev_array[_i3].title == "土曜日") {
        weekdaysAbbrev_array[_i3].style = "color: rgb(225, 233, 255);";
      }
    }
  }
};
...
document.addEventListener('DOMContentLoaded', function () {
  // 「OK」ボタンの削除
  var datepicker_ok_button = document.getElementsByClassName("datepicker-done");
  ...
  var datepicker_clear = document.querySelector(".datepicker-clear");
...
/***/ "./app/javascript/channels/target.js":
/*!*******************************************!*\
  !*** ./app/javascript/channels/target.js ***!
  \*******************************************/
/*! no static exports found */
...
var favorability_rating_array = document.querySelectorAll(".index_favorability_rating");
var progress_rating_array = document.querySelectorAll(".index_progress_rating"); // 好感度が「70%」〜「79％」

for (var i = 0; i < favorability_rating_array.length; i++) {
...
for (var _i = 0; _i < favorability_rating_array.length; _i++) {
  if (Number(favorability_rating_array[_i].textContent.replace("％", "")) >= 80) {
    favorability_rating_array[_i].classList.add('_80_or_over');
  }
} // 進展度が「70%」〜「79％」


for (var _i2 = 0; _i2 < progress_rating_array.length; _i2++) {
  if (70 <= Number(progress_rating_array[_i2].textContent.replace("％", "")) && Number(progress_rating_array[_i2].textContent.replace("％", "")) < 80) {
    progress_rating_array[_i2].classList.add('_70_or_over_and_under_80');
  }
} // 進展度が「80%」〜「100％」


for (var _i3 = 0; _i3 < progress_rating_array.length; _i3++) {
  if (Number(progress_rating_array[_i3].textContent.replace("％", "")) >= 80) {
    progress_rating_array[_i3].classList.add('_80_or_over');
  }
}
...
/* harmony import */ var _channels_Jquery_selmodal_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../channels/Jquery.selmodal.js */ "./app/javascript/channels/Jquery.selmodal.js");
/* harmony import */ var _channels_Jquery_selmodal_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_channels_Jquery_selmodal_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _channels_datepicker_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../channels/datepicker.js */ "./app/javascript/channels/datepicker.js");
/* harmony import */ var _channels_datepicker_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_channels_datepicker_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _channels_date_result_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../channels/date_result.js */ "./app/javascript/channels/date_result.js");
/* harmony import */ var _channels_date_result_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_channels_date_result_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _channels_target_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../channels/target.js */ "./app/javascript/channels/target.js");
/* harmony import */ var _channels_target_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_channels_target_js__WEBPACK_IMPORTED_MODULE_6__);
...
/******/ });
//# sourceMappingURL=application-fcba76fec4a440d10f34.js.map