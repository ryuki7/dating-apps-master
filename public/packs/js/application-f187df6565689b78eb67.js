...
var city_select_start_button_click_discrimination = "no"; //
    ...
    if (prefectures_select_button.textContent == '都道府県を選択してください') {
      ...
      if (!city_select_button_fake_delete) {
        ...
        if (targets_edit_sign_input && city_select_start_button_click_discrimination == "ok") {
          var city_select_start_button_click = document.getElementById("city_select_start_button");
...
/******/ });
//# sourceMappingURL=application-f187df6565689b78eb67.js.map