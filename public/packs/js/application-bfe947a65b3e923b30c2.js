  ...
  city_select_start_button.addEventListener('mouseup', function () {
    if (prefectures_select_button.textContent == '都道府県を選択してください') {} else {
      ...
      if (!city_select_button_fake_delete) {
        ...
        var city_select_option_elements_array = document.querySelectorAll(prefectures_select_button.textContent);
...
/******/ });
//# sourceMappingURL=application-bfe947a65b3e923b30c2.js.map