...
function beforesubmit_select_check() {
  ...
  } else if (name_select.classList.contains("valid") || name_select.classList.contains("invalid") && targets_registration_name_error_message !== null) {
  ...
  if (name_select.classList.contains("invalid") && targets_registration_name_word_count_error_message == null) {
    ...
    name_word_count_error_message.textContent = '「名前」は4文字までにして下さい。';
...
/******/ });
//# sourceMappingURL=application-d04e99213cc0f3fcdd54.js.map